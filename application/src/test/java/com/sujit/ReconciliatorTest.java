...
class ReconciliatorTest {
  ...
  public void init() throws ParseException {
    ...
    testDirectory =
        new File(
            "." + File.separator + "src" + File.separator + "test" + File.separator + "testFiles");
    ...
    sourceList.add(
        new Transaction(
            ...
            "donation",
            csvDateFormat.parse("2020-01-15"),
            'D'));
    sourceList.add(
        new Transaction(
            "TR-47884222202",
            ...
            "travel",
            csvDateFormat.parse("2020-01-20"),
            'D'));
    sourceList.add(
        new Transaction(
            "TR-47884222204",
            ...
            Currency.getInstance("JOD"),
            "donation",
            csvDateFormat.parse("2020-01-31"),
            'C'));
    ...
    targetList.add(
        new Transaction(
            ...
            Currency.getInstance("USD"),
            "donation",
            jsonDateFormat.parse("15/01/2020"),
            'D'));
    targetList.add(
        new Transaction(
            "TR-47884222202",
  ...
  public void given2FilesWhenExecutedThenShouldProvideTwoListOfTransactions() throws IOException {
    ...
    reconciliator.arrangeDataThenApplyReconciliation(
        "/home/sujit/clusus/file1.csv", "/home/sujit/clusus/file2.json");
  }
  ...
  @Test
  public void
      givenListOfSourceAndTargetWithDestinationDir_WhenReconciliate_ShouldSeparateTransactionOnMatchingMismatchingAndMissingFiles() {
    reconciliator.reconciliate(sourceList, targetList);
  }
}
